...
import com.narayana.eatexpress.data.EatExpressLoginViewModel
...
@Composable
fun LoginScreen(loginViewModel: EatExpressLoginViewModel = viewModel()) {
        ...
        Surface(
            ...
            Column( modifier = Modifier.fillMaxSize()) {
                ...
                MyTextFieldComponent(labelValue = stringResource(id = R.string.email),
                    ...
                    onTextChanged = { loginViewModel.onEvent(EatExpressLoginUIEvent.EmailChanged(it)) },
                ...
                PasswordTextFieldComponent(
                    ...
                    onTextSelected = {
                        loginViewModel.onEvent(EatExpressLoginUIEvent.PasswordChanged(it))
                    },
                ...
                ButtonComponent(
                    ...
                    onButtonClicked = {
                       loginViewModel.onEvent(EatExpressLoginUIEvent.LoginButtonClicked)
                    },
